...
`chmod u+x <filename>`
 ...
 Аналогично setuid, бит setgid выставляется с помощью команды
`chmod g + s <filename>` 
ассмотрим на примере создания нового файл с именем _myfile2_.
...
```
 ...
 Последний специальный бит разрешения – это **Sticky Bit**
